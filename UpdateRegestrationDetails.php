...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<h4 class="page-header">Editar detalhes de registro</h4>
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					Primeiro nome : <input type="text" name="fname" value="<?php echo $row['FName']; ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					Gênero : <input type="text" name="g" value="<?PHP echo $row['Gender'];?>"><br>
				</div>
				<div class="form-group">
					Número de telefone : <input type="tel" name="phno" value="<?PHP echo $row['PhNo'];?>" maxlength="10"><br>
				</div>
				<div class="form-group">
