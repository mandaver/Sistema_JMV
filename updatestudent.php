		...
		<div class="col-md-12">
			...
			<form action="" method="POST" name="update">
				<div class="form-group">
					ID Registro : <input type="text" name="sregid" value="<?php echo $row['SRegID']; ?>" readonly>
				</div>
				<div class="form-group">
					Número de inscrição : <input type="text" name="eno" value="<?php echo $row['Eno']; ?>" readonly>
				</div>
				<div class="form-group">
					Nome : <input type="text" name="fname" value="<?php echo $row['FName']; ?>">
				</div>
				<div class="form-group">
					Sobrenome : <input type="text" name="lname" value="<?php echo $row['LName']; ?>"><br>
				</div>
				<div class="form-group">
					Nome do pai : <input type="text" name="faname" value="<?PHP echo $row['FaName'];?>"><br>
				</div>
				<div class="form-group">
					Endereço : <input type="text" name="addrs" value="<?PHP echo $row['Addrs'];?>"><br>
				</div>
				<div class="form-group">
					Gênero : <input type="text" name="gender" value="<?PHP echo $row['Gender'];?>"><br>
				</div>
				<div class="form-group">
					Curso : <input type="text" name="course" value="<?PHP echo $row['Course'];?>"><br>
				</div>
				<div class="form-group">
					D.O.B. : <input type="text" name="DOB" value="<?PHP echo $row['DOB'];?>" readonly><br>
				</div>
				<div class="form-group">
					Número de telefone : <input type="text" name="phno" value="<?PHP echo $row['PhNo'];?>" maxlength="10"><br>
				</div>
				<div class="form-group">
					Email : <input type="text" name="email" value="<?PHP echo $row['Eid'];?>" readonly><br>
				</div>
				<div class="form-group">
					Senha : <input type="text" name="pass" value="<?PHP echo $row['Pass'];?>"><br>
				</div><br>
				<div class="form-group">
