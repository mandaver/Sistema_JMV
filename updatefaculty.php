	...
	<div class="container">
     <div class="row">
            <div class="col-md-12">
				...
				ID Docente : <?php echo $row['FID']; ?></div>
				<div class="form-group">
				Nome do docente : <input type="text" name="fname" value="<?php echo $row['FName']; ?>"></div>
				<div class="form-group">
				Nome do pai : <input type="text" name="faname" value="<?PHP echo $row['FaName'];?>"><br></div>
				<div class="form-group">
				Address : <input type="text" name="addrs" rows="5" cols="40" value="<?PHP echo $row['Addrs'];?>"><br></div>
				<div class="form-group">
				Gênero : <input type="text" name="gender" value="<?PHP echo $row['Gender'];?>"><br></div>
				<div class="form-group">
				Número de telefone : <input type="tel" name="phno" value="<?PHP echo $row['PhNo'];?>" maxlength="10"><br></div>
				<div class="form-group">
				Data de ingresso : <input type="date" name="jdate" value="<?PHP echo $row['JDate'];?>" readonly> <br></div>
				<div class="form-group">
				Cidade : <input type="text" name="city" value="<?PHP echo $row['City'];?>" ><br></div>
				<div class="form-group">
				Senha : <input type="text" name="pass" value="<?PHP echo $row['Pass'];?>" maxlength="10"><br></div><br>
				<div class="form-group">
