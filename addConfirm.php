...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<h4 class="page-header">Edite qualquer detalhe caso necessário</h4>
			<?php
			...
			<form action="" method="POST" name="updateform">
				...
				<div class="form-group">
					Genêro : <input type="text" name="gender" value="<?PHP echo $row['Gender'];?>"><br>
				</div>

				<div class="form-group">
					Celular : <input type="tel" name="phno" value="<?PHP echo $row['PhNo'];?>" maxlength="10"><br>
				</div>
				<div class="form-group">
