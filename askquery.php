...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h3> Bem-Vindo <a href="welcomestudent.php" <?php echo "<span style='color:red'>".$userfname." ".$userlname."</span>";?> </a></h3>
			<?php 
				...
				<div class="row">
					<div class="col-md-5">
						<form action="" method="POST" name="update">
							<fieldset>
								<legend>Detalhe da consulta</legend>
								<table>
									<td>
										<h3>
									...
									<td>
										<tr><strong><h3>Consulta :</h3></strong> </tr><br <tr><textarea rows="10" cols="40" name="squeryx" class="form-control" required></textarea>
										</tr>
									</td>
								</table>
								<br>
